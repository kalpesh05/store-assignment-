...
const routes = [
  ...
  // Add more Product, Category routes with Swagger comments...
];

// Applying routes dynamically
routes.forEach(route => {
  ...
  // Validators for non-GET/DELETE methods
  ...
  if (route.swagger) {
    ...
    // Add Swagger metadata dynamically
    swaggerMeta[route.path] = swagger;  // Assuming you have a swaggerMeta object to hold these
  }
